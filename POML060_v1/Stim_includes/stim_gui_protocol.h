...
typedef enum {
    ...
    /*
        // register space reserved for footswitches 3 - 5
        STIM_REG_FOOTSWITCH3_CONNECTED=72,
        STIM_REG_FOOTSWITCH3_MODE=73,
        STIM_REG_FOOTSWITCH3_VALUE=74,
        STIM_REG_FOOTSWITCH3_UPDATE_RATE=75,
        STIM_REG_FOOTSWITCH4_CONNECTED=76,
        STIM_REG_FOOTSWITCH4_MODE=77,
        STIM_REG_FOOTSWITCH4_VALUE=78,
        STIM_REG_FOOTSWITCH4_UPDATE_RATE=79,
        STIM_REG_FOOTSWITCH5_CONNECTED=80,
        STIM_REG_FOOTSWITCH5_MODE=81,
        STIM_REG_FOOTSWITCH5_VALUE=82,
        STIM_REG_FOOTSWITCH5_UPDATE_RATE=83
    */
        STIM_REG_NUMBER_OF_UNPAUSE_EVENTS=84,
        STIM_REG_TOTAL_POWER_ON_TIME_S=88,
        STIM_REG_TOTAL_UNPAUSED_TIME_S=92,
        STIM_REG_UNUSED_ADDRESS=96,
...
typedef enum {
    ...
    STIM_LONG_REG_LOG_FILE=13,
    STIM_LONG_REG_UNUSED_ADDRESS=14,
} STIM_LONG_REG_ID_T;
...
typedef enum {
    ...
    STIM_COMMAND_RESET_USER_INTENSITIES=11,
    STIM_COMMAND_RESET_ALL_VARIABLES=12,
    STIM_COMMAND_RESET_LOG_HEADER=13,
    STIM_COMMAND_RESET_LOG_PHASE_DATA=14,
