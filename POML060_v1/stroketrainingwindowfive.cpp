...
#include "ui_stroketrainingwindowfive.h"
...
StrokeTrainingWindowFive::StrokeTrainingWindowFive(QString patientLabel,QMap<QString, QString> defaultValues, int page, bool configId, QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::StrokeTrainingWindowFive)
{
    ui->setupUi(this);
    pLabel = patientLabel;
    progPage = page;
    ...
    ui->radioButton_p1t3->setEnabled(false);
   ...
   // Save the original geometry of each widget
    ...
    if (progPage == 0)
    {
        QPixmap pix(":/resources/envStrokeProg53.jpg"); // this is the code to add image to the form
        ...
        test_config_file_pr5 = "config_sProg5_test_"+pLabel;
        config_file_pr5 = "config_sProg5_final_"+pLabel;
          if (configId ==0)
        {

            loadConfigFile(test_config_file_pr5);
        ...
        {
            loadConfigFile(config_file_pr5);
        }
...
StrokeTrainingWindowFive::~StrokeTrainingWindowFive()
{
    delete ui;
}

void StrokeTrainingWindowFive::strokeTrainingPhaseEventHandler(STIM_GUI_TOPIC_T topic, uint8_t index, uint8_t reg, uint32_t value)
{
    if (progPage ==0)
    {
        if (topic==TOPIC_STIMULATOR)
        {
            ...
            case STIM_SUB_ACT_REG_CURRENT_PHASE:
                ...
                QList<QPushButton *> List{ui->btn11,ui->btn12,ui->btn13,ui->btn14};
...
void StrokeTrainingWindowFive::closeEvent(QCloseEvent *event)
{

}

void StrokeTrainingWindowFive::resizeEvent(QResizeEvent *event)
{
...
int StrokeTrainingWindowFive::adjust_Ramp_Step_size(int pwvalue, float rmpvalue)
{
    int rmp_step_size = static_cast<int>(1000 * (pwvalue / (rmpvalue * 30.0)));
    return rmp_step_size;
}

void StrokeTrainingWindowFive::P1W1Changer_Prog5(int pwvalue)
{
    tetra_grip_api::set_stimulation_target_pulse_width( m_channelOne, 1, pwvalue);

}

void StrokeTrainingWindowFive::P1W2Changer_Prog5(int pwvalue)
{
    tetra_grip_api::set_stimulation_target_pulse_width( m_channelTwo, 1, pwvalue);
}

void StrokeTrainingWindowFive::nextButton_Prog5(int pwvalue)
{
    m_currentBtn1++;
...
void StrokeTrainingWindowFive::on_pushButton_clicked()
{
...
QString StrokeTrainingWindowFive::defaultValuesToString(const QMap<QString, QString> &defaultValues)
{
    QStringList list;
...
void StrokeTrainingWindowFive::setupUiComponents(QMap<QString, QString> &defaultValues)
{
    ...
    const double delayValues[] {0, 0.2, 0.4 ,0.6, 0.8, 1 , 1.2, 1.4,1.6,1.8,2.0};
    ...
    if(defaultValues.value("PW_Stroke5_PW_Ch1").isEmpty())
    {
    ...
    {
        ui->comboBox_p1pw1->setCurrentText(defaultValues["PW_Stroke5_PW_Ch1"]+ "uS");
        ui->comboBox_p1pw2->setCurrentText(defaultValues["PW_Stroke5_PW_Ch2"]+ "uS");

        ui->comboBox_p1rr1->setCurrentText(QString::number(defaultValues["Ramp_Stroke5_RR_Ch1"].toFloat()*1000)+"ms");
        ui->comboBox_p1rr2->setCurrentText(QString::number(defaultValues["Ramp_Stroke5_RR_Ch2"].toFloat()*1000)+"ms");

        ui->comboBox_p1rf1->setCurrentText(QString::number(defaultValues["Ramp_Stroke5_RF_Ch1"].toFloat()*1000)+"ms");
        ui->comboBox_p1rf2->setCurrentText(QString::number(defaultValues["Ramp_Stroke5_RF_Ch2"].toFloat()*1000)+"ms");

        ui->comboBox_onTime1->setCurrentText(defaultValues["TDur_Stroke5_OnTime1"]+ "ms");
        ui->comboBox_p1dur->setCurrentText(defaultValues["TDur_Stroke5_Duration"]+ "min");
        ui->comboBox_p1d2->setCurrentText(defaultValues["Delay_Stroke5_Delay_Ch2"]+ "ms");
    }
...
void StrokeTrainingWindowFive::readXmlFile()
{

}

void StrokeTrainingWindowFive::configureUiComponents()
{
    ui->btn_nextPhase1->setEnabled(false);
}

void StrokeTrainingWindowFive::setUiElementsEnabled(bool enabled)
{
...
void StrokeTrainingWindowFive::configureConnections()
{
    connect(&api, &tetra_grip_api::tetraGripEvent,this, &StrokeTrainingWindowFive::strokeTrainingPhaseEventHandler);
    connect(this, &StrokeTrainingWindowFive::P1W1_Value_Prog5, this, &StrokeTrainingWindowFive::P1W1Changer_Prog5);
    connect(this, &StrokeTrainingWindowFive::P1W2_Value_Prog5, this, &StrokeTrainingWindowFive::P1W2Changer_Prog5);
    //connect(this, &StrokeTrainingWindow::settingsLoaded, this, &StrokeTrainingWindow::updateUiWithSettings);

}

void StrokeTrainingWindowFive::loadConfigFile(QString filename)
{
...
void StrokeTrainingWindowFive::downloadConfigFile(QString filename)
{
    QString txtWritePath = QCoreApplication::applicationDirPath()+"/data/config_file/"+filename+".txt";
...
void StrokeTrainingWindowFive::saveToXMLFile()
{
    ...
    QDomElement newSP2PWTag = document.createElement(QString("PW_Stroke5"));
    QDomElement newRTag = document.createElement(QString("Ramp_Stroke5"));
    QDomElement newDelayTag = document.createElement(QString("Delay_Stroke5"));
    QDomElement newTDur2Tag = document.createElement(QString("TDur_Stroke5"));
    QDomElement newRR2Tag = document.createElement(QString("Ramp_Step_Stroke5"));


    QDomNode SP2PWNode = root.elementsByTagName("PW_Stroke5").at(0).firstChild();
    QDomElement SP2PWNodeVal = SP2PWNode.toElement();
    QDomNode RNode = root.elementsByTagName("Ramp_Stroke5").at(0).firstChild();
    QDomElement RNodeVal = RNode.toElement();
    QDomNode DelayNode = root.elementsByTagName("Delay_Stroke5").at(0).firstChild();
    QDomElement DelayNodeVal = DelayNode.toElement();
    QDomNode TDurNode = root.elementsByTagName("TDur_Stroke5").at(0).firstChild();
    QDomElement TDurNodeVal = TDurNode.toElement();
    QDomNode RR2Node = root.elementsByTagName("Ramp_Step_Stroke5").at(0).firstChild();
    ...
    {
          QDomElement root = document.documentElement();
          QDomNode SettingsNode = root.namedItem("PW_Stroke5");
   ...
   {
         QDomElement root = document.documentElement();
         QDomNode RampSettingsNode = root.namedItem("Ramp_Stroke5");
   ...
   {
         QDomElement root = document.documentElement();
         QDomNode RampSettingsNode = root.namedItem("Delay_Stroke5");
   ...
   {
         QDomElement root = document.documentElement();
         QDomNode TDurNode = root.namedItem("TDur_Stroke5");
    ...
    {
        QDomElement root = document.documentElement();
        QDomNode RampSettingsNode = root.namedItem("Ramp_Step_Stroke5");
...
void StrokeTrainingWindowFive::loadCurrentWidgetValues()
{
...
void StrokeTrainingWindowFive::on_pushButton_stimStart1_clicked()
{
...
void StrokeTrainingWindowFive::on_pushButton_stimStop1_clicked()
{
...
void StrokeTrainingWindowFive::on_btn_nextPhase1_clicked()
{
...
void StrokeTrainingWindowFive::on_comboBox_p1pw1_currentIndexChanged(int index)
{
    PW_Ch1 = index;
    emit P1W1_Value_Prog5(index);
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg5Final(pLabel);
    ui->pushButton_configSet->setEnabled(true);
...
void StrokeTrainingWindowFive::on_comboBox_p1pw2_currentIndexChanged(int index)
{
    PW_Ch2 = index;
    emit P1W2_Value_Prog5(index);
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg5Final(pLabel);
    ui->pushButton_configSet->setEnabled(true);
...
void StrokeTrainingWindowFive::on_comboBox_p1rr1_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg5Final(pLabel);
...
void StrokeTrainingWindowFive::on_comboBox_p1rf1_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg5Final(pLabel);
...
void StrokeTrainingWindowFive::on_comboBox_p1rr2_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg5Final(pLabel);
...
void StrokeTrainingWindowFive::on_comboBox_p1rf2_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg5Final(pLabel);
...
void StrokeTrainingWindowFive::on_comboBox_p1d2_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg5Final(pLabel);
...
void StrokeTrainingWindowFive::on_comboBox_p1dur_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg5Final(pLabel);
...
void StrokeTrainingWindowFive::on_pushButton_configSet_clicked()
{
    ...
    {
        ManageConfigFile configFile;
        configFile.sProg5Final2(pLabel);
        config_file_pr52 = "config_sProg5_final2_"+pLabel;
        loadConfigFile(config_file_pr52);
    }
    else if(triggerIMU == 1 && triggerTime == 0 && triggerButton == 0)
    {
        ManageConfigFile configFile;
        configFile.sProg5Final3(pLabel);
        config_file_pr53 = "config_sProg5_final3_"+pLabel;
        loadConfigFile(config_file_pr53);
    }
    else
    {
        loadConfigFile(config_file_pr5);
...
void StrokeTrainingWindowFive::on_radioButton_p1t1_clicked()
{
    saveToXMLFile();
    triggerIMU = false;
    triggerTime= true;
...
void StrokeTrainingWindowFive::on_radioButton_p1t2_clicked()
{
    saveToXMLFile();
    triggerIMU = false;
    triggerTime= false;
...
void StrokeTrainingWindowFive::on_radioButton_p1t3_clicked()
{
    saveToXMLFile();
    triggerIMU = true;
    triggerTime= false;
...
void StrokeTrainingWindowFive::on_comboBox_onTime1_currentIndexChanged(int index)
{
    saveToXMLFile();
    ui->pushButton_stimStart1->setEnabled(false);
    ui->pushButton_configSet->setEnabled(true);
...
void StrokeTrainingWindowFive::on_pushButton_triggerApply_clicked()
{
    if(triggerButton == 1 && triggerTime == 0 && triggerIMU == 0)
    {
        ManageConfigFile configFile;
...
void StrokeTrainingWindowFive::on_pushButton_download1_clicked()
{
    if(triggerButton == 1 && triggerTime == 0 && triggerIMU == 0)
    {
        downloadConfigFile(config_file_pr5);
    }
    else if(triggerTime == 1 && triggerIMU == 0 && triggerButton == 0)
    {
        config_file_pr52 = "config_sProg5_final2_"+pLabel;
        downloadConfigFile(config_file_pr52);
    }
    else if(triggerIMU == 1 && triggerTime == 0 && triggerButton == 0)
    {
        config_file_pr53 = "config_sProg5_final3_"+pLabel;
        downloadConfigFile(config_file_pr53);
    }
    else
    {
        downloadConfigFile(config_file_pr5);
...
void StrokeTrainingWindowFive::on_checkBox_stateChanged(int arg1)
{
