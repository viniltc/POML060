#ifndef STROKETRAININGWINDOWSIX_H
#define STROKETRAININGWINDOWSIX_H
...
namespace Ui {
class StrokeTrainingWindowSix;
}

class StrokeTrainingWindowSix : public QMainWindow
{
    Q_OBJECT

public:
    explicit StrokeTrainingWindowSix(QString, QMap<QString, QString>, int, bool, QWidget *parent = nullptr);
    ~StrokeTrainingWindowSix();
    QString pLabel;
    int progPage;
...
public slots:
   ...
   // void closeEvent (QCloseEvent *event);
    ...
    void P1W1Changer_Prog6(int pwvalue);
    void P1W2Changer_Prog6(int pwvalue);
    void P1W3Changer_Prog6(int pwvalue);
    void nextButton_Prog6(int pwvalue);

signals:
    void nxtButtonChanged_prog6(int id, int pwvalue);
    void P1W1_Value_Prog6(int);
    void P1W2_Value_Prog6(int);
    void P1W3_Value_Prog6(int);

private:
    Ui::StrokeTrainingWindowSix *ui;
    ...
    QString config_file_pr6;
    QString config_file_pr62;
    QString config_file_pr63;
    QString test_config_file_pr6;
...
#endif // STROKETRAININGWINDOWSIX_H
