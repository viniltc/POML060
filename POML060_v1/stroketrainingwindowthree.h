#ifndef STROKETRAININGWINDOWTHREE_H
#define STROKETRAININGWINDOWTHREE_H
...
namespace Ui {
class StrokeTrainingWindowThree;
}

class StrokeTrainingWindowThree : public QMainWindow
{
    Q_OBJECT

public:
    explicit StrokeTrainingWindowThree(QString,QMap<QString, QString>, int, bool,QWidget *parent = nullptr);
    ~StrokeTrainingWindowThree();
    QString pLabel;
    int progPage;
...
private:
    Ui::StrokeTrainingWindowThree *ui;
    ...
    QString config_file_pr3;
    QString config_file_pr32;
    QString config_file_pr33;
    QString test_config_file_pr3;
...
#endif // STROKETRAININGWINDOWTHREE_H
