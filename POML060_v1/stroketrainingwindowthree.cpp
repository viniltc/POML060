...
#include "ui_stroketrainingwindowthree.h"
...
StrokeTrainingWindowThree::StrokeTrainingWindowThree(QString patientLabel,QMap<QString, QString> defaultValues, int page, bool configId, QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::StrokeTrainingWindowThree)
{
    ui->setupUi(this);
    pLabel = patientLabel;
    progPage = page;
   ...
   // ui->pushButton_triggerApply->setEnabled(false);
    ...
    if (progPage == 0)
    {
        QPixmap pix(":/resources/envStrokeProg31.jpg"); // this is the code to add image to the form
        ...
        test_config_file_pr3 = "config_sProg3_test_"+pLabel;
        config_file_pr3 = "config_sProg3_final_"+pLabel;
        if (configId ==0)
        {
...
StrokeTrainingWindowThree::~StrokeTrainingWindowThree()
{
    delete ui;
}

void StrokeTrainingWindowThree::strokeTrainingPhaseEventHandler(STIM_GUI_TOPIC_T topic, uint8_t index, uint8_t reg, uint32_t value)
{
    if (progPage ==0)
    {
...
void StrokeTrainingWindowThree::closeEvent(QCloseEvent *event)
{
...
void StrokeTrainingWindowThree::resizeEvent(QResizeEvent *event)
{
...
void StrokeTrainingWindowThree::on_pushButton_clicked()
{
...
QString StrokeTrainingWindowThree::defaultValuesToString(const QMap<QString, QString> &defaultValues)
{
    QStringList list;
...
void StrokeTrainingWindowThree::setupUiComponents(QMap<QString, QString> &defaultValues)
{
    ...
    if(defaultValues.value("PW_Stroke3_PW_Ch1").isEmpty())
    {
    ...
    {
        ui->comboBox_p1pw1->setCurrentText(defaultValues["PW_Stroke3_PW_Ch1"]+ "uS");
        ui->comboBox_p1pw2->setCurrentText(defaultValues["PW_Stroke3_PW_Ch2"]+ "uS");
        ui->comboBox_p1pw3->setCurrentText(defaultValues["PW_Stroke3_PW_Ch3"]+ "uS");
        ui->comboBox_p1rr1->setCurrentText(QString::number(defaultValues["Ramp_Stroke3_RR_Ch1"].toFloat()*1000)+"ms");
        ui->comboBox_p1rr2->setCurrentText(QString::number(defaultValues["Ramp_Stroke3_RR_Ch2"].toFloat()*1000)+"ms");
        ui->comboBox_p1rr3->setCurrentText(QString::number(defaultValues["Ramp_Stroke3_RR_Ch3"].toFloat()*1000)+"ms");
        ui->comboBox_p1rf1->setCurrentText(QString::number(defaultValues["Ramp_Stroke3_RF_Ch1"].toFloat()*1000)+"ms");
        ui->comboBox_p1rf2->setCurrentText(QString::number(defaultValues["Ramp_Stroke3_RF_Ch2"].toFloat()*1000)+"ms");
        ui->comboBox_p1rf3->setCurrentText(QString::number(defaultValues["Ramp_Stroke3_RF_Ch3"].toFloat()*1000)+"ms");
        ui->comboBox_onTime1->setCurrentText(defaultValues["TDur_Stroke3_OnTime1"]+ "ms");
        ui->comboBox_p1dur->setCurrentText(defaultValues["TDur_Stroke3_Duration"]+ "min");
       // ui->comboBox_p1d2->setCurrentText(defaultValues["Delay_Stroke3_Delay_Ch2"]+ "ms");
    }
...
void StrokeTrainingWindowThree::readXmlFile()
{

}

void StrokeTrainingWindowThree::configureUiComponents()
{
      ui->btn_nextPhase1->setEnabled(false);
}

void StrokeTrainingWindowThree::setUiElementsEnabled(bool enabled)
{
...
void StrokeTrainingWindowThree::configureConnections()
{
    connect(&api, &tetra_grip_api::tetraGripEvent,this, &StrokeTrainingWindowThree::strokeTrainingPhaseEventHandler);
    connect(this, &StrokeTrainingWindowThree::P1W1_Value_Prog2, this, &StrokeTrainingWindowThree::P1W1Changer_Prog2);
    connect(this, &StrokeTrainingWindowThree::P1W2_Value_Prog2, this, &StrokeTrainingWindowThree::P1W2Changer_Prog2);
    connect(this, &StrokeTrainingWindowThree::P1W3_Value_Prog2, this, &StrokeTrainingWindowThree::P1W3Changer_Prog2);
    //connect(this, &StrokeTrainingWindow::settingsLoaded, this, &StrokeTrainingWindow::updateUiWithSettings);

}

void StrokeTrainingWindowThree::loadConfigFile(QString filename)
{
...
void StrokeTrainingWindowThree::downloadConfigFile(QString filename)
{
    QString txtWritePath = QCoreApplication::applicationDirPath()+"/data/config_file/"+filename+".txt";
...
void StrokeTrainingWindowThree::saveToXMLFile()
{
    ...
    QDomElement newSP3PWTag = document.createElement(QString("PW_Stroke3"));
    QDomElement newRTag = document.createElement(QString("Ramp_Stroke3"));
    QDomElement newDelayTag = document.createElement(QString("Delay_Stroke3"));
    QDomElement newTDur3Tag = document.createElement(QString("TDur_Stroke3"));
    QDomElement newRR3Tag = document.createElement(QString("Ramp_Step_Stroke3"));


    QDomNode SP3PWNode = root.elementsByTagName("PW_Stroke3").at(0).firstChild();
    QDomElement SP3PWNodeVal = SP3PWNode.toElement();
    QDomNode RNode = root.elementsByTagName("Ramp_Stroke3").at(0).firstChild();
    QDomElement RNodeVal = RNode.toElement();
    QDomNode DelayNode = root.elementsByTagName("Delay_Stroke3").at(0).firstChild();
    QDomElement DelayNodeVal = DelayNode.toElement();
    QDomNode TDurNode = root.elementsByTagName("TDur_Stroke3").at(0).firstChild();
    QDomElement TDurNodeVal = TDurNode.toElement();
    QDomNode RR3Node = root.elementsByTagName("Ramp_Step_Stroke3").at(0).firstChild();
    ...
    {
          QDomElement root = document.documentElement();
          QDomNode SettingsNode = root.namedItem("PW_Stroke3");
   ...
   {
         QDomElement root = document.documentElement();
         QDomNode RampSettingsNode = root.namedItem("Ramp_Stroke3");
   ...
   {
         QDomElement root = document.documentElement();
         QDomNode RampSettingsNode = root.namedItem("Delay_Stroke3");
   ...
   {
         QDomElement root = document.documentElement();
         QDomNode TDurNode = root.namedItem("TDur_Stroke3");
    ...
    {
        QDomElement root = document.documentElement();
        QDomNode RampSettingsNode = root.namedItem("Ramp_Step_Stroke3");
...
void StrokeTrainingWindowThree::loadCurrentWidgetValues()
{
...
void StrokeTrainingWindowThree::on_comboBox_p1pw1_currentIndexChanged(int index)
{
    PW_Ch1 = index;
...
void StrokeTrainingWindowThree::on_comboBox_p1pw2_currentIndexChanged(int index)
{
    PW_Ch2 = index;
...
void StrokeTrainingWindowThree::on_comboBox_p1pw3_currentIndexChanged(int index)
{
    PW_Ch3 = index;
...
void StrokeTrainingWindowThree::on_pushButton_stimStart1_clicked()
{
...
void StrokeTrainingWindowThree::on_pushButton_stimStop1_clicked()
{
    tetra_grip_api::stimulation_pause(true);
...
void StrokeTrainingWindowThree::on_btn_nextPhase1_clicked()
{
...
void StrokeTrainingWindowThree::on_pushButton_configSet_clicked()
{
...
//    }
    ...
    {
         ManageConfigFile configFile;
         configFile.sProg3Final2(pLabel);
         config_file_pr32 = "config_sProg3_final2_"+pLabel;
        loadConfigFile(config_file_pr32);
    }
    else if(triggerIMU == 1 && triggerTime == 0 && triggerButton == 0)
    {
        if (triggerIMUWrist==1&&triggerIMUShoulder==0&&triggerIMUtimeout==0)
        {
            ...
            configFile.sProg3Final3_1_1(pLabel);
            config_file_pr33 = "config_sProg3_final311_"+pLabel;
            loadConfigFile(config_file_pr33);
        }
        else if (triggerIMUWrist==1&&triggerIMUShoulder==0&&triggerIMUtimeout==1)
        {
            ManangeConfigExtended configFile;
            configFile.sProg3Final3_1_2(pLabel);
            config_file_pr33 = "config_sProg3_final312_"+pLabel;
            loadConfigFile(config_file_pr33);
        }
        else if (triggerIMUWrist==0&&triggerIMUShoulder==1&&triggerIMUtimeout==0)
        {
            ManangeConfigExtended configFile;
            configFile.sProg3Final3_2_1(pLabel);
            config_file_pr33 = "config_sProg3_final321_"+pLabel;
            loadConfigFile(config_file_pr33);
        }
        else if (triggerIMUWrist==0&&triggerIMUShoulder==1&&triggerIMUtimeout==1)
        {
            ManangeConfigExtended configFile;
            configFile.sProg3Final3_2_2(pLabel);
            config_file_pr33 = "config_sProg3_final322_"+pLabel;
            loadConfigFile(config_file_pr33);
        }
        ...
        {
            ManageConfigFile configFile;
            configFile.sProg3Final3(pLabel);
            config_file_pr33 = "config_sProg3_final3_"+pLabel;
            loadConfigFile(config_file_pr33);
        }
...
void StrokeTrainingWindowThree::on_comboBox_p1rr1_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg3Final(pLabel);
...
void StrokeTrainingWindowThree::on_comboBox_p1rf1_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg3Final(pLabel);
...
void StrokeTrainingWindowThree::on_comboBox_p1rr2_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg3Final(pLabel);
...
void StrokeTrainingWindowThree::on_comboBox_p1rf2_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg3Final(pLabel);
...
void StrokeTrainingWindowThree::on_comboBox_p1d2_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg3Final(pLabel);
...
void StrokeTrainingWindowThree::on_comboBox_p1rr3_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg3Final(pLabel);
...
void StrokeTrainingWindowThree::on_comboBox_p1rf3_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg3Final(pLabel);
...
void StrokeTrainingWindowThree::on_comboBox_p1dur_currentIndexChanged(int index)
{
    saveToXMLFile();
    ManageConfigFile configFile;
    configFile.sProg3Final(pLabel);
...
void StrokeTrainingWindowThree::on_radioButton_p1t1_clicked()
{
    saveToXMLFile();
    triggerIMU = false;
    triggerTime= true;
...
void StrokeTrainingWindowThree::on_radioButton_p1t2_clicked()
{
    saveToXMLFile();
    triggerIMU = false;
    triggerTime= false;
...
void StrokeTrainingWindowThree::on_radioButton_p1t3_clicked()
{
    saveToXMLFile();
    triggerIMU = true;
    triggerTime= false;
...
void StrokeTrainingWindowThree::on_comboBox_onTime1_currentIndexChanged(int index)
{
    saveToXMLFile();
    ui->pushButton_stimStart1->setEnabled(false);
    ui->pushButton_configSet->setEnabled(true);
...
/*void StrokeTrainingWindowThree::on_pushButton_triggerApply_clicked()
{
    if(triggerButton == 1 && triggerTime == 0 && triggerIMU == 0)
    {
        ManageConfigFile configFile;
...
void StrokeTrainingWindowThree::on_pushButton_download1_clicked()
{
    if(triggerButton == 1 && triggerTime == 0 && triggerIMU == 0)
    {
        downloadConfigFile(config_file_pr3);
    }
    else if(triggerTime == 1 && triggerIMU == 0 && triggerButton == 0)
    {
        config_file_pr32 = "config_sProg3_final2_"+pLabel;
        downloadConfigFile(config_file_pr32);
    }
    else if(triggerIMU == 1 && triggerTime == 0 && triggerButton == 0)
    {
        if (triggerIMUWrist==1&&triggerIMUShoulder==0&&triggerIMUtimeout==0)
        {
            config_file_pr33 = "config_sProg3_final311_"+pLabel;
            downloadConfigFile(config_file_pr33);
        }
        else if (triggerIMUWrist==1&&triggerIMUShoulder==0&&triggerIMUtimeout==1)
        {
            config_file_pr33 = "config_sProg3_final312_"+pLabel;
...
void StrokeTrainingWindowThree::on_toolButton_imu1_clicked()
{
  //  ui->pushButton_triggerApply->setEnabled(true);
    IMUDialog *newdialog;
    //this->hide();
    ...
    connect(newdialog, &IMUDialog::radioButtonChanged, this, &StrokeTrainingWindowThree::IMUExtSettings);
    connect(newdialog, &IMUDialog::checkBoxChanged, this, &StrokeTrainingWindowThree::IMUExtSettingsCheckBox);

    newdialog->setAttribute(Qt::WA_DeleteOnClose);
    newdialog -> show();
}

void StrokeTrainingWindowThree::IMUExtSettings(const QString &buttonText)
{
...
void StrokeTrainingWindowThree::IMUExtSettingsCheckBox(bool status)
{
    if (status ==true)
    {
...
void StrokeTrainingWindowThree::on_checkBox_stateChanged(int arg1)
{
