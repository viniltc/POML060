...
void ProgramKeyGripV2::mousePressEvent(QMouseEvent *event)
{
    ...
    if (distance ( mp, p42) < 20 && ( mp.x() > p42.x() && mp.x() < p43.x() ) && checked1) {
    ...
    else if (distance ( mp, p12) < 20 && ( mp.x() > p12.x() && mp.x() < p13.x() ) && checked2) {
        dragging2 = true;
        CurPoint1 = &p12;
        CurPoint2 = &p13;

    }
    else if (distance ( mp, p22) < 20 && ( mp.x() > p22.x() && mp.x() < p23.x() ) && checked3) {
        dragging3 = true;
        CurPoint1 = &p22;
        CurPoint2 = &p23;
    ...
    else if (distance ( mp, p32) < 20 && ( mp.x() > p32.x() && mp.x() < p33.x() ) && checked4) {
        dragging4 = true;
        CurPoint1 = &p32;
        CurPoint2 = &p33;
